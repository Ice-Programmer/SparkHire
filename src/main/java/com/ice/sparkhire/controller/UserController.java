...
import com.ice.sparkhire.model.user.UserBasicInfoVO;
...
public class UserController {
     ...
     */
    @GetMapping("/current")
    public BaseResponse<UserBasicInfoVO> getCurrentLoginUser() {
        ...
        BeanUtils.copyProperties(currentUser, userBasicInfoVO);
        return ResultUtils.success(userBasicInfoVO);
    }
}
